...
public class Shadow : Unit, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    public void Attack()
    {
        ...
        ////Attack
        GameManager.Data.Battle.commandQueue.Enqueue(new AttackCommand(this, GameManager.Data.Battle.nowPlayer, animator, GameManager.Data.Battle.nowPlayer.animator, GameManager.Data.Battle.nowSkill, null)); ;
